...
st.markdown("- Our app recognizes ingredients on uploaded images using a powerful algorithm called yolov7. We trained this Convolutional Neural Network on a dataset of 10,000 images featuring 131 categories of ingredients (fruits, vegetables, eggs).")
st.markdown("- We created a FastAPI to run the object detection on the uploaded image and return the objects and their confidence levels.")
st.markdown("- We've also integrated Restegourmet's API, which provides a wide range of recipes.")
